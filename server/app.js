...
async function sendAppShell(res) {
  ...
  if (!html.includes('/css/tasks-v3.css')) additions.push('<link rel="stylesheet" href="/css/tasks-v3.css?v=3">');
  else html = html.replace(/\/css\/tasks-v3\.css\?v=\d+/g, '/css/tasks-v3.css?v=3');
  if (!html.includes('/css/issues-v3.css')) additions.push('<link rel="stylesheet" href="/css/issues-v3.css?v=2">');
  ...
  additions.push('<link rel="stylesheet" href="/css/final-polish.css?v=14">');
