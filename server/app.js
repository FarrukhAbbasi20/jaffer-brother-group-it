...
async function sendAppShell(res) {
  ...
  if (!html.includes('/css/searchable-multiselect.css')) additions.push('<link rel="stylesheet" href="/css/searchable-multiselect.css?v=1">');
  else html = html.replace(/\/css\/searchable-multiselect\.css\?v=\d+/g, '/css/searchable-multiselect.css?v=1');
  additions.push('<link rel="stylesheet" href="/css/final-polish.css?v=28">');
  ...
  if (!html.includes('/js/searchable-multiselect.js')) scripts.push('<script src="/js/searchable-multiselect.js?v=1"></script>');
  else html = html.replace(/\/js\/searchable-multiselect\.js\?v=\d+/g, '/js/searchable-multiselect.js?v=1');
