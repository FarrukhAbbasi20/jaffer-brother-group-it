...
async function sendAppShell(res) {
  ...
  const additions = [];
  if (!html.includes('/css/overview-v3.css')) additions.push('<link rel="stylesheet" href="/css/overview-v3.css?v=6">');
  else html = html.replace(/\/css\/overview-v3\.css\?v=\d+/g, '/css/overview-v3.css?v=6');
  if (!html.includes('/css/projects-v3.css')) additions.push('<link rel="stylesheet" href="/css/projects-v3.css?v=2">');
  else html = html.replace(/\/css\/projects-v3\.css\?v=\d+/g, '/css/projects-v3.css?v=2');
  if (!html.includes('/css/sidebar-v3.css')) additions.push('<link rel="stylesheet" href="/css/sidebar-v3.css?v=2">');
  if (!html.includes('/css/calendar-v3.css')) additions.push('<link rel="stylesheet" href="/css/calendar-v3.css?v=2">');
  else html = html.replace(/\/css\/calendar-v3\.css\?v=\d+/g, '/css/calendar-v3.css?v=2');
  ...
  if (!html.includes('/css/tasks-v3.css')) additions.push('<link rel="stylesheet" href="/css/tasks-v3.css?v=4">');
  else html = html.replace(/\/css\/tasks-v3\.css\?v=\d+/g, '/css/tasks-v3.css?v=4');
  if (!html.includes('/css/issues-v3.css')) additions.push('<link rel="stylesheet" href="/css/issues-v3.css?v=3">');
  else html = html.replace(/\/css\/issues-v3\.css\?v=\d+/g, '/css/issues-v3.css?v=3');
  if (!html.includes('/css/milestones-v3.css')) additions.push('<link rel="stylesheet" href="/css/milestones-v3.css?v=2">');
  else html = html.replace(/\/css\/milestones-v3\.css\?v=\d+/g, '/css/milestones-v3.css?v=2');
  ...
  additions.push('<link rel="stylesheet" href="/css/final-polish.css?v=16">');
  if (additions.length) html = html.replace('</head>', additions.join('\n') + '\n</head>');
  const scripts = [];
  if (!html.includes('/js/overview-v3.js')) scripts.push('<script src="/js/overview-v3.js?v=5"></script>');
  else html = html.replace(/\/js\/overview-v3\.js\?v=\d+/g, '/js/overview-v3.js?v=5');
  if (!html.includes('/js/projects-v3.js')) scripts.push('<script src="/js/projects-v3.js?v=2"></script>');
  else html = html.replace(/\/js\/projects-v3\.js\?v=\d+/g, '/js/projects-v3.js?v=2');
  ...
  if (!html.includes('/js/sidebar-v3.js')) scripts.push('<script src="/js/sidebar-v3.js?v=9"></script>');
  else html = html.replace(/\/js\/sidebar-v3\.js\?v=\d+/g, '/js/sidebar-v3.js?v=9');
  ...
  if (!html.includes('/js/tasks-v3.js')) scripts.push('<script src="/js/tasks-v3.js?v=5"></script>');
  else html = html.replace(/\/js\/tasks-v3\.js\?v=\d+/g, '/js/tasks-v3.js?v=5');
  if (!html.includes('/js/issues-v3.js')) scripts.push('<script src="/js/issues-v3.js?v=2"></script>');
  else html = html.replace(/\/js\/issues-v3\.js\?v=\d+/g, '/js/issues-v3.js?v=2');
  if (!html.includes('/js/milestones-v3.js')) scripts.push('<script src="/js/milestones-v3.js?v=2"></script>');
  else html = html.replace(/\/js\/milestones-v3\.js\?v=\d+/g, '/js/milestones-v3.js?v=2');
  ...
  if (!html.includes('/js/kpi-animate.js')) scripts.push('<script src="/js/kpi-animate.js?v=1"></script>');
  else html = html.replace(/\/js\/kpi-animate\.js\?v=\d+/g, '/js/kpi-animate.js?v=1');
